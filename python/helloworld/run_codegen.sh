...
# Just in case you didn't install the GRPC Python plugin, we'll poke around for
# you.
...
protoc -I ../../protos --python_out=. --grpc_out=. --plugin=protoc-gen-grpc=$GRPC_PYTHON_PLUGIN ../../protos/helloworld.proto
